...
protein_vocab = torch.load(os.path.join(root, 'utils/protein-vocab.pt'),weights_only=False)
smiles_vocab = torch.load(os.path.join(root, 'utils/smiles-vocab.pt'),weights_only=False)
